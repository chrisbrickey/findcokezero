...
- `findcoke1/static/` is source code. Edit these files directly.
- `findcoke1/staticfiles/` is auto-generated by django.

   **To manually trigger generation of the content for `staticfiles`:**
   ```
